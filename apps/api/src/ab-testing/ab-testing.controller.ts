...
export class ABTestingController {
  ...
  @Get()
  @ApiOperation({ summary: 'Get A/B tests (project-scoped, org-scoped, or aggregated)' })
  findAll(
    ...
    return this.abTestingService.findAll({ projectId, organizationId, aggregated: aggregated === 'true' });
  }

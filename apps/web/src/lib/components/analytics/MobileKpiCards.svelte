<script lang="ts">
  ...
  import type { GooglePlayMetricsTotals } from '@marketing-ai/shared-types';
  ...
  $: cards = [
    {
      ...
      value: totals ? formatNumber(totals.installs.value) : '--',
      change: totals?.installs.change ?? 0,
      trend: totals?.installs.trend ?? 'flat',
    ...
    },
    {
      ...
      value: totals ? formatRating(totals.averageRating.value) : '--',
      change: totals?.averageRating.change ?? 0,
      trend: totals?.averageRating.trend ?? 'flat',
    ...
    },
    {
      ...
      value: totals ? formatRevenue(totals.revenue.value) : '--',
      change: totals?.revenue.change ?? null,
      trend: totals?.revenue.trend ?? null,
    ...
    },
    {
      ...
      value: totals ? formatPercent(totals.crashRate.value) : '--',
      change: totals?.crashRate.change ?? 0,
      trend: totals?.crashRate.trend ?? 'flat',

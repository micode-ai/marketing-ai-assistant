...
<div class="bg-surface rounded-xl border border-border p-5">
  ...
  <div class="flex items-start justify-between mb-3">
    ...
    <div class="flex items-center gap-0.5">
      {#each Array(5) as _, i}
        <svg class="w-4 h-4 {i < review.starRating ? 'text-yellow-400' : 'text-ink-subtle'}" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div class="mt-3 space-y-2">
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            ...
            class="px-3 py-1.5 text-sm text-ink-muted hover:text-ink cursor-pointer"
          >
            {$_('common.cancel')}
          </button>
        </div>

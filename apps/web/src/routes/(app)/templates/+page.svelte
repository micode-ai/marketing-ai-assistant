<script lang="ts">
  ...
  const templates: Template[] = [
    ...
    },
    {
      ...
      color: 'text-blue-600 bg-blue-500/12',
    ...
    },
    {
      ...
      color: 'text-green-600 bg-green-500/12',
    ...
    },
    {
      ...
      color: 'text-orange-600 bg-orange-500/12',
    ...
    },
    {
      ...
      color: 'text-pink-600 bg-pink-500/12',
    ...
    },
    {
      ...
      color: 'text-brand bg-brand-subtle/10',
    ...
    },
    {
      ...
      color: 'text-red-600 bg-red-500/12',
    ...
    },
    {
      ...
      color: 'text-slate-600 bg-slate-500/12',
    ...
    {#each templates as t}
      ...
      >
        ...
        <div class="flex items-center justify-between">
          <span class="text-xs px-2 py-1 rounded-full {t.type === 'checklist' ? 'bg-green-500/12 text-green-700' : 'bg-blue-500/12 text-blue-700'}">
            {$_('templates.' + t.type)}
          </span>
  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40" on:click|self={() => { showProjectPicker = false; pendingTemplate = null; }} on:keydown={(e) => e.key === 'Escape' && (showProjectPicker = false, pendingTemplate = null)} role="dialog" tabindex="-1">
    <div class="bg-surface rounded-2xl shadow-xl p-6 max-w-sm w-full mx-4">
      ...
      <button on:click={() => { showProjectPicker = false; pendingTemplate = null; }}
        class="mt-4 w-full px-4 py-2 text-sm font-medium text-ink bg-surface-2 rounded-lg hover:bg-surface-2 transition-colors cursor-pointer">

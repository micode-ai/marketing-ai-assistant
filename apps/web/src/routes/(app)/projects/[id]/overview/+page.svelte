...
<div class="p-4 sm:p-6">
  ...
  {:else if loading}
    <div class="animate-pulse space-y-6">
      <div class="flex items-center gap-4">
        <div class="w-14 h-14 bg-surface-2 rounded-2xl"></div>
        <div class="flex-1">
          <div class="h-6 bg-surface-2 rounded w-1/3 mb-2"></div>
